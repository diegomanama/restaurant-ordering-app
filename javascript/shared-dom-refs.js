...
export const closeOrderModalButton = document.querySelector("#close-order-modal-button");
export const completeOrderButton = document.querySelector("#complete-order-button");
